"""
jingwei-user 冒烟测试（不依赖真实 MongoDB，使用内存假集合）。
...
def client(monkeypatch):
    ...
    from jingwei_user.api.user_server.main import app
...
def test_app_import_chain():
    from jingwei_user import __version__
    from jingwei_user.api.user_server.main import app
    from jingwei_user.infra.user.user_service import get_profile, set_role
