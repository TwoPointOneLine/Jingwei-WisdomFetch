...
from jingwei_common.ai import list_models, llm_provider
from jingwei_common.clients import (
    milvus_client,
    minio_client,
    mongo_client,
)
from jingwei_common.clients.mongo_client import MONGO_DB_NAME, MONGO_URL
...
from jingwei_common.utils import chunk_text, clean_text, md5, safe_get
from jingwei_common.utils.prompt_utils import load_prompt
from jingwei_common.web import (
    ApiError,
    ApiResponse,
    SSEEvent,
    create_sse_queue,
...
def main() -> None:
    ...
    # 1) 版本与项目根
    print(f"{'version':<16}: {jingwei_common.__version__}")
