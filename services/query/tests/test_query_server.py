...
def test_app_imports():
    from shopkeeper_query.api.query_server.main import app
...
def test_query_chain_importable():
    ...
    from shopkeeper_query.process.query_chain.state import _last_write_wins
...
def test_rag_core_importable():
    from shopkeeper_query.rag.query import (
        fuse_by_rrf,
        llm_answer,
        vector_retrieve,
        web_search,
...
def test_infra_importable():
    from shopkeeper_query.infra.mcp import search_web_documents
    from shopkeeper_query.infra.persistence import history_repo, persistence
