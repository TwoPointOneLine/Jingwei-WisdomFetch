"""
shopkeeper-auth 冒烟测试（不依赖真实 MongoDB，使用内存假集合）。
...
def client(monkeypatch):
    ...
    from shopkeeper_auth.api.auth_server.main import app
...
def test_app_import_chain():
    ...
    from shopkeeper_auth import __version__
    from shopkeeper_auth.api.auth_server.main import app
    from shopkeeper_auth.infra.auth.auth_service import register, validate_token
