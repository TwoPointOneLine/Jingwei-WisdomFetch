...
from shopkeeper_common.auth import get_user_role
from shopkeeper_common.config import settings
from starlette.responses import JSONResponse

from shopkeeper_auth.api.schemas.auth_schema import AuthResponse, LoginRequest, RegisterRequest
from shopkeeper_auth.infra.auth.auth_service import (
    issue_token,
    register,
    revoke_token,
    validate_token,
...
app = FastAPI(
    ...
    description="掌柜智库 认证服务：注册、登录、鉴权。",
    version="0.1.0",
)
app.add_middleware(
    CORSMiddleware,
